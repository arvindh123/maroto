...
func TestSignature_AddSpaceFor_DefaultMargins(t *testing.T) {
	...
	text.AssertCalled(t, "Add", "label", internal.Cell{5.0, 7.0, 2.0, 0.0}, props.Text{Size: 10.0, Color: color.Color{Red: 20, Green: 20, Blue: 20}})
}
...
func TestSignature_AddSpaceFor_NotDefaultMargins(t *testing.T) {
	...
	text.AssertNumberOfCalls(t, "Add", 1)
	text.AssertCalled(t, "Add", "label", internal.Cell{2.0, 7.0, 5.0, 0.0}, props.Text{Size: 10.0, Color: color.Color{Red: 20, Green: 20, Blue: 20}})
}
